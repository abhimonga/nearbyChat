package com.example.underdark_check;
 ...
 private static String TAG = "MainActivity";
    ...
    private void startAdvertising() {
        ...
        Nearby.getConnectionsClient(MainActivity.this)
                .startAdvertising("Example",
                         "com.example.under_dark.check", connectionLifecycleCallback, advertisingOptions)
    ...
    private void startDiscovery() {
        ...
        Nearby.getConnectionsClient(this)
                .startDiscovery("com.example.under_dark.check", endpointDiscoveryCallback, discoveryOptions)
                .addOnSuccessListener(
                        new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void unused) {
